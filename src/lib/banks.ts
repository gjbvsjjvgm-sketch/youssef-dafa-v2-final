...
export const GULF_BANKS: Record<string, BankBranding[]> = {
  ...
  AE: [
    ...
    { id: "cbd", nameAr: "بنك دبي التجاري", nameEn: "CBD", logo: "/assets/branding/logo-cbd-ae.png", color: "#004B87" },
    { id: "rakbank", nameAr: "بنك رأس الخيمة", nameEn: "RAKBANK", logo: "/assets/branding/logo-rakbank-ae.png", color: "#00539F" },
  ...
  KW: [
    ...
    { id: "cbk", nameAr: "البنك التجاري الكويتي", nameEn: "CBK", logo: "/assets/branding/logo-cbk.png", color: "#1A3B77" },
    { id: "abk", nameAr: "البنك الأهلي الكويتي", nameEn: "ABK", logo: "/assets/branding/logo-abk-eahli.png", color: "#00447C" },
  ...
  QA: [
    ...
    { id: "alrayan", nameAr: "مصرف الريان", nameEn: "Al Rayan", logo: "/assets/branding/logo-alrayan.png", color: "#4B2A7B" },
    { id: "ahli_qa", nameAr: "البنك الأهلي", nameEn: "Ahli Bank", logo: "/assets/branding/logo-ahlibank-com-qa.png", color: "#003F72" },
    { id: "qiib", nameAr: "الدولي الإسلامي", nameEn: "QIIB", logo: "/assets/branding/logo-qiib-com-qa.png", color: "#1A3B77" }
  ],
  BH: [
    ...
    { id: "ithmaar", nameAr: "بنك إثمار", nameEn: "Ithmaar Bank", logo: "/assets/branding/logo-ithmaar.png", color: "#4B2A7B" },
  ...
  OM: [
    ...
    { id: "oab", nameAr: "البنك العربي العماني", nameEn: "OAB", logo: "/assets/branding/logo-oman-arabbank.png", color: "#00447C" },
    { id: "nizwa", nameAr: "بنك نزوى", nameEn: "Bank Nizwa", logo: "/assets/branding/logo-banknizwa-om.png", color: "#2C5F2D" },
    { id: "ahli_om", nameAr: "البنك الأهلي", nameEn: "Ahli Bank", logo: "/assets/branding/logo-ahlibank-om.png", color: "#003F72" },
    { id: "alizz", nameAr: "بنك العز الإسلامي", nameEn: "Al Izz Bank", logo: "/assets/branding/logo-alizzislamic.png", color: "#4B2A7B" }
  ]
};
